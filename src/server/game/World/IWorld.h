...
enum WorldIntConfigs
{
    ...
    CONFIG_GLYPH_DYNAMIC_UNLOCK_MAJOR_1,
    CONFIG_GLYPH_DYNAMIC_UNLOCK_MAJOR_2,
    CONFIG_GLYPH_DYNAMIC_UNLOCK_MAJOR_3,
    CONFIG_GLYPH_DYNAMIC_UNLOCK_MINOR_1,
    CONFIG_GLYPH_DYNAMIC_UNLOCK_MINOR_2,
    CONFIG_GLYPH_DYNAMIC_UNLOCK_MINOR_3,
